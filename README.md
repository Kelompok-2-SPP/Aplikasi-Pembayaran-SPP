...
| Student (Siswa) 👩‍🎓 | Officer (Petugas) 👨‍💼 | Officer (Petugas) 🔑  | 
| ------------------ | -------------------- | ---------------------  |
| <code><img width=300 height=650 src="https://github.com/Kelompok-2-SPP/Aplikasi-Pembayaran-SPP/blob/master/.github/siswa.gif?raw=true" alt="Student preview"></code> | <code><img width=300 height=650 src="https://github.com/Kelompok-2-SPP/Aplikasi-Pembayaran-SPP/blob/master/.github/petugas.gif?raw=true" alt="Student preview"></code> | <code><img width=300 height=650 src="https://github.com/Kelompok-2-SPP/Aplikasi-Pembayaran-SPP/blob/master/.github/admin.gif?raw=true" alt="Student preview"></code> |
